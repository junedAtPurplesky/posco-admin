 ...
 *
 * @param {TCircleLoaderProps} props - The component props.
 * @returns {JSX.Element} The rendered CircleLoader component.
 */
export const CircleLoader: React.FC<TCircleLoaderProps> = ({
  size = "medium",
  className = "",
}) => {
  const sizeClasses = {
