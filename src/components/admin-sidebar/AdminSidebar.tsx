...
export function AdminSidebar({
  ...
  return (
    <aside className="flex flex-col justify-between w-full h-full bg-white overflow-hidden">
      {/* Sidebar Top Section */}
      <div>
        ...
        {/* Sidebar Links */}
        <ul className="flex flex-col gap-4 overflow-scroll admin-sidebar-links-container w-full pb-20">
